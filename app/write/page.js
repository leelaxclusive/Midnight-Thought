...
export default function Write() {
  ...
  const addTag = () => {
    if (tagInput.trim() && !storyForm.tags.includes(tagInput.trim()) && storyForm.tags.length < 10) {
      setStoryForm(prev => ({
        ...prev,
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-foreground mb-2">
            {editStory ? `Edit Story: ${editStory.title}` : 'Create New Story'}
          </h1>
          <p className="text-muted-foreground">
            {editStory
              ? 'Update your story details, status, and settings.'
              : 'Start your literary journey by creating a new story. You can add chapters later from your dashboard.'
            }
          </p>
        </div>
        ...
        <Card>
            <CardHeader>
              <CardTitle>
                {editStory ? 'Story Settings' : 'Create New Story'}
              </CardTitle>
              <CardDescription>
                {editStory
                  ? 'Update your story information and settings'
                  : 'Create a new story and set its basic information'
                }
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleStorySubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setStoryForm(prev => ({ ...prev, genre: value }))}
                    >
                      <SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    placeholder="Describe your story... What's it about? What can readers expect?"
                    required
                    maxLength={1000}
                    className="min-h-[120px]"
                  />
                  <p className="text-xs text-muted-foreground">
                    {storyForm.description.length}/1000 characters
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setStoryForm(prev => ({ ...prev, status: value }))}
                    >
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setStoryForm(prev => ({ ...prev, visibility: value }))}
                    >
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setStoryForm(prev => ({ ...prev, language: value }))}
                    >
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
